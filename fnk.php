...
function raamatuVorm(){
    echo '
        <form action="'.$_SERVER['PHP_SELF'].'" method="post">
            ...
            Trykikoda: <input type="text" name="print"><br />
...
// Koostame functiooni, mis salvestab vormiandmed faili
...
// Koostame funktsiooni, mis vormiandmed salvestab massiivi
